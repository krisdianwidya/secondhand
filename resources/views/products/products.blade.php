...
<a href="{{ route('products.show', $product->id) }}" class="col-md-4 p-0 shadow-sm text-decoration-none text-dark">
    <div class="card">
        <div class="row justify-content-center mt-md-3">
            <img src="{{ asset('storage/assets/uploads/'.json_decode($product->image)[0]) }}" class="card-img-top img-fluid" style="max-width: 200px; max-height: 200px; object-fit: scale-down;" alt="...">
        </div>
